...
export default mergeConfigs([
  config,
  {
    rules: [
      ...
      ['font-ja', { 'font-family': '"Noto Sans JP", "Hiragino Sans", "Noto Sans CJK JP", sans-serif' }],
      ['font-ja-serif', { 'font-family': '"Noto Serif JP", "Hiragino Mincho ProN", "Noto Serif CJK JP", serif' }],
    ],
    safelist: [
